 ...
 *
 */
public class RejectComponentCap {
     ...
     */
    protected static final XMLFormat<RejectComponentCap> REJECT_COMPONENT_MAP_XML = new XMLFormat<RejectComponentCap>(RejectComponentCap.class) {

        @Override
        public void read(javolution.xml.XMLFormat.InputElement xml, RejectComponentCap data) throws XMLStreamException {
            data.data.clear();
        ...
        @Override
        public void write(RejectComponentCap data, javolution.xml.XMLFormat.OutputElement xml) throws XMLStreamException {
            if (data.data.size() > 0) {
