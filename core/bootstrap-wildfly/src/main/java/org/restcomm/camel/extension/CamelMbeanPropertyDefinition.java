...
public class CamelMbeanPropertyDefinition extends SimpleResourceDefinition {
    ...
    public static final CamelMbeanPropertyDefinition INSTANCE = new CamelMbeanPropertyDefinition();
    ...
    private CamelMbeanPropertyDefinition() {
        super(PROPERTY_PATH,
                CamelExtension.getResourceDescriptionResolver(CamelMbeanDefinition.MBEAN + "." + PROPERTY),
                CamelMbeanPropertyAdd.INSTANCE,
                CamelMbeanPropertyRemove.INSTANCE);
    }
