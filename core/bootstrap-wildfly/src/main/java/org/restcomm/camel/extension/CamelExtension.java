...
public class CamelExtension implements Extension {
  ...
  private final Logger log = Logger.getLogger(CamelExtension.class);

  /**
   * The name of our subsystem within the model.
   */
  public static final String SUBSYSTEM_NAME = "camel-extensions";
  ...
  static StandardResourceDescriptionResolver getResourceDescriptionResolver(final String keyPrefix) {
    ...
    return new StandardResourceDescriptionResolver(prefix, RESOURCE_NAME, CamelExtension.class.getClassLoader(), true, false);
  }

  @Override
  public void initializeParsers(ExtensionParsingContext context) {
    context.setSubsystemXmlMapping(SUBSYSTEM_NAME, Namespace.CURRENT.getUriString(), CamelSubsystemParser.getInstance());
  }
  ...
  public void initialize(ExtensionContext context) {
    ...
    subsystem.registerXMLElementWriter(CamelSubsystemParser.getInstance());

    // here we can register submodels
    final ManagementResourceRegistration mbeans = registration.registerSubModel(CamelMbeanDefinition.INSTANCE);
  }
}
