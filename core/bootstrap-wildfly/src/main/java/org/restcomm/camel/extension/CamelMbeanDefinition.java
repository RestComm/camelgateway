 ...
 */
public class CamelMbeanDefinition extends SimpleResourceDefinition {
    ...
    public static final CamelMbeanDefinition INSTANCE = new CamelMbeanDefinition();
    ...
    private CamelMbeanDefinition() {
        super(MBEAN_PATH,
                CamelExtension.getResourceDescriptionResolver(MBEAN),
                CamelMbeanAdd.INSTANCE,
                CamelMbeanRemove.INSTANCE);
    }

    @Override
    public void registerChildren(ManagementResourceRegistration resourceRegistration) {
        super.registerChildren(resourceRegistration);
        resourceRegistration.registerSubModel(CamelMbeanPropertyDefinition.INSTANCE);
    }
