...
import org.restcomm.camel.service.CamelService;
...
class SubsystemAdd extends AbstractBoottimeAddStepHandler {
    ...
    public void performBoottime(OperationContext context, ModelNode operation, ModelNode model,
        ...
        CamelService service = CamelService.INSTANCE;
        service.setModel(fullModel);

        ServiceName name = CamelService.getServiceName();
        ServiceController<CamelService> controller = context.getServiceTarget()
